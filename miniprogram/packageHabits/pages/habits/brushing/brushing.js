...
Page({
  ...
  goTimer(e) {
    ...
    wx.navigateTo({
      url: '/packageHabits/pages/habits/brushing-timer/brushing-timer?time=' + timeOfDay
    })
  },
  ...
  editPhotoInDraw(e) {
    ...
    wx.navigateTo({
      url: '/packageCreate/pages/create/draw/draw?mode=brushing&photo=' + encodeURIComponent(path) + '&timeOfDay=' + timeOfDay
    })
  },
