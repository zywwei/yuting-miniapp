var templateList = require('/packageCreate/utils/templates.js').templateList
...
Page({
  ...
  selectTemplate: function(e) {
    ...
    wx.navigateTo({
      url: '/packageCreate/pages/create/draw/draw?mode=template&templateId=' + template.id + '&name=' + template.name
    })
  }
})
