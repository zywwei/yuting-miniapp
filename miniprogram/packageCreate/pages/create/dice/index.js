...
Page({
  ...
  goCompare: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/dice/compare/index' })
  },

  goCollection: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/dice/collection/index' })
  },

  goMission: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/dice/mission/index' })
  },

  goSlots: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/dice/slots/index' })
  }
})
