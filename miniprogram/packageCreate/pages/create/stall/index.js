...
Page({
  ...
  goSale: function() {
    ...
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/sale/sale' })
  },

  goProducts: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/price-board/price-board' })
  },

  goHistory: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/history/history' })
  },

  goStats: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/stats/stats' })
  },
  ...
  goChangeCalc: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/change-calc/change-calc' })
  },

  goPricingHelper: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/pricing-helper/pricing-helper' })
  },

  goRestockList: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/restock-list/restock-list' })
  },

  goBusinessDiary: function() {
    wx.navigateTo({ url: '/packageCreate/pages/create/stall/business-diary/business-diary' })
  },
